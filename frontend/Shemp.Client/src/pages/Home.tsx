...
const Home: React.FC = () => (
  <div className="min-h-screen flex flex-col">
    ...
    <section className="relative bg-linear-to-br from-purple-50 via-blue-50 to-pink-50 pt-20 pb-32 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-linear-to-r from-purple-600 via-blue-600 to-pink-600 bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-linear-to-r from-purple-600 to-blue-500 text-white rounded-lg font-semibold text-lg hover:shadow-2xl hover:scale-105 transition transform">
              Start Creating Free
            </button>
    ...
    <section id="features" className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-linear-to-br from-purple-50 to-purple-100 p-8 rounded-2xl hover:shadow-xl transition">
            <div className="w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center mb-4 text-2xl">📸</div>
          ...
          <div className="bg-linear-to-br from-pink-50 to-pink-100 p-8 rounded-2xl hover:shadow-xl transition">
            <div className="w-12 h-12 bg-pink-600 rounded-lg flex items-center justify-center mb-4 text-2xl">🎨</div>
          ...
          <div className="bg-linear-to-br from-indigo-50 to-indigo-100 p-8 rounded-2xl hover:shadow-xl transition">
            <div className="w-12 h-12 bg-indigo-600 rounded-lg flex items-center justify-center mb-4 text-2xl">⚡</div>
    ...
    {/* CTA Section */}
    <section id="about" className="py-20 px-6 bg-linear-to-r from-purple-600 to-blue-600">
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <button className="px-10 py-4 bg-white text-purple-600 rounded-lg font-bold text-lg hover:shadow-2xl hover:scale-105 transition transform">
